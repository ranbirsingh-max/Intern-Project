            ...
            {OrderHistory && OrderHistory.length === 0 && (
                <div className='h-[80vh] p-4 text-zinc-100'>
                    <div className='h-[100%] flex flex-col items-center justify-center'>
                        <h1 className='text-3xl font-bold'>No Order History</h1>
                        <img
                            src='http://cnd-icons-png.falticon.com/128/9961/9961218.png'
                            alt='/'
                            className='h-[20vh] md:w-8' // Fixed the className here
                        />
                    </div>
                </div>
            )}
